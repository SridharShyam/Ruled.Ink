...
export default function NowBanner() {
    ...
    return (
      <div className="mb-10 py-2 border-l-[3px] border-border px-4 bg-transparent">
        <div className="flex flex-col gap-1">
          <span className="font-mono text-[10px] text-muted uppercase tracking-[0.1em] font-medium">▸ status</span>
  ...
  return (
    <div className="mb-10 py-2 border-l-[3px] border-accent px-4 bg-transparent">
      <div className="flex flex-col gap-1">
        <span className="font-mono text-[10px] text-muted uppercase tracking-[0.1em] font-medium">
          ▸ now
        </span>
